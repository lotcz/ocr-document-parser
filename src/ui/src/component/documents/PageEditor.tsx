...
export default function PageEditor({entity, template, onChange}: DocumentPageEditorProps) {
	...
	return (
		<div className="page-editor">
			{
				entity && finalPageTemplate && finalPageTemplate.scanFullText && <div className="m-2">
					<Form.Control as="textarea" rows={5} readOnly={true} value={StringUtil.getNonEmpty(entity.fullText)}/>
				</div>
			}
